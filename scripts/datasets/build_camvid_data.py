...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    '/hdd02/zhangyiyang/data/CamVid/train/images',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    '/hdd02/zhangyiyang/data/CamVid/train/labels',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    '/hdd02/zhangyiyang/data/CamVid/valid/images',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    '/hdd02/zhangyiyang/data/CamVid/valid/labels',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'test_image_folder',
    '/hdd02/zhangyiyang/data/CamVid/test/images',
    'Folder containing test images')

tf.app.flags.DEFINE_string(
    'test_image_label_folder',
    '/hdd02/zhangyiyang/data/CamVid/test/labels',
    'Folder containing annotations for test')

tf.app.flags.DEFINE_string(
    'output_dir', '/hdd02/zhangyiyang/data/CamVid/tfrecords',
...
def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir):
    """Converts the CamVid dataset into into tfrecord format.
    ...
    img_names = tf.io.gfile.glob(os.path.join(dataset_dir, '*.png'))
    ...
    for f in img_names:
        ...
        seg = os.path.join(dataset_label_dir, basename + '_L.png')
        print(f, seg)
...
def main(unused_argv):
    ...
    _convert_dataset('test', FLAGS.test_image_folder,
