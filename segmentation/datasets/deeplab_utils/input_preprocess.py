...
def get_mean_pixel(model_variant=None):
...
def preprocess_image_and_label(image,
    ...
    Args:
      ...
      model_variant: Model variant (string) for choosing how to
        mean-subtract the images. See feature_extractor.network_map
    ...
    if is_training and (crop_height is None or crop_width is None):
        raise ValueError(
            'During training, crop height and crop width must be provided')
    ...
    if label is not None and crop_height is not None \
