...
__all__ = ['NASNet', 'NASNetLarge', 'NASNetMobile']
...
def NASNet(input_shape=None,
    ...
    model = tf.keras.models.Model(img_input, x, name='NASNet')
    ...
    with tf.keras.backend.name_scope('adjust_block'):
        if p is None:
            ...
            with tf.keras.backend.name_scope(
                    'adjust_reduction_block_%s' % block_id):
            ...
            with tf.keras.backend.name_scope(
                    'adjust_projection_block_%s' % block_id):
