...
def get_dataset(dataset_name,
  ...
  def _parse_function(example_proto):
    ...
    image = _decode_image(parsed_features[common.TF_RECORD_IMAGE_ENCODED], channels=3)

    label = None
    if split_name != common.TEST_SET:
      label = _decode_image(
          parsed_features[common.TF_RECORD_IMAGE_SEGMENTATION_CLASS_ENCODED], channels=1)
