...
import random
import sys
from datasets.deeplab_utils import build_data
...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    '/ssd/zhangyiyang/data/ADE20K/ADEChallengeData2016/images/training',
    'Folder containing trainng images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    '/ssd/zhangyiyang/data/ADE20K/ADEChallengeData2016/annotations/training',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    '/ssd/zhangyiyang/data/ADE20K/ADEChallengeData2016/images/validation',
    'Folder containing validation images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    '/ssd/zhangyiyang/data/ADE20K/ADEChallengeData2016/annotations/validation',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'output_dir', '/ssd/zhangyiyang/data/ADE20K/tfrecord',
