...
def SemanticFeatureGenerationBlock(inputs, D_features, D_prime_features, O_features, bottleneck_factor=2,
                                   cardinality=32):
...
def build_ddsc(inputs, num_classes, preset_model='DDSC', frontend="ResNet101", weight_decay=1e-5, is_training=True,
    ...
    decoder_1 = SemanticFeatureGenerationBlock(decoder_1, D_features=128, D_prime_features=128 / 4,
