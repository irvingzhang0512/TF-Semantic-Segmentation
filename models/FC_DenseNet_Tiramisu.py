...
def build_fc_densenet(inputs, num_classes, preset_model='FC-DenseNet56', weight_decay=0.00001,
                      n_filters_first_conv=48, n_pool=5,
    ...
    if preset_model == 'FC-DenseNet56':
        ...
        raise ValueError(
            "Unsupported FC-DenseNet model '%s'. "
            "This function only supports FC-DenseNet56, FC-DenseNet67, and FC-DenseNet103" % (
                preset_model))
